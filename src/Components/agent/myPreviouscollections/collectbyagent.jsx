...
const CollectDonationagent = () => {
  ...
  useEffect(() => {
    ...
    const fetchCollectionData = async () => {
      ...
      try {
        const response = await fetch(`https://foood-ngo-jj.onrender.com/api/v1/agent/agent/collection/collect/${collectionId}`, {
          method: 'GET',
          credentials: 'include',
          headers: {
    ...
    <main>
      ...
      <div id="main-wrapper">
        ...
        <div className="border m-4 my-3 p-4 bg-white rounded-2 shadow-sm">
          you have collect food successfully 
          {/* <div className="mb-2">
...
export default CollectDonationagent;
